      ...
      <div className="bg-tdBg bg-cover bg-no-repeat h-[340px] grid items-center">
        <div>
          {/* <div className="flex justify-center items-center gap-4 bg-[#2563EB33] p-2 w-[205px] mx-auto text-white">
            ...
            <h1 className="capitalize font-[500] text-[14px] leading-[20px] text-center">
              contact us
            </h1>
            <svg
              width="7"
          ...
          <h1 className="text-[32px] md:text-[54px] leading-[64px] font-[700] text-white text-center mt-2 capitalize">
            contact us
          </h1>

          <div className="flex justify-center items-center gap-2 mt-5">
            <h1 className="text-sm font-[500] leading-[21px] text-center text-blue-600">
              Home
            </h1>
            <svg
              width="17"
            ...
            <h2 className="text-sm font-[500] leading-[21px] text-center text-white capitalize">
              contact us
            </h2>
          </div>
        </div>
